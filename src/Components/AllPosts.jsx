      ...
      <tr key={post.id}>
        ...
        <td>
          <input
            ...
            onChange={this.handleFieldEdit.bind(this, post.id, "title")}
          />
        </td>
        <td>
          <input
            ...
            onChange={this.handleFieldEdit.bind(this, post.id, "author")}
          />
        </td>
        <td>
          <button onClick={this.handleEditSave.bind(this, post.id)}>
            Save
          </button>
          <button onClick={this.handleEditCancel.bind(this, post.id)}>
            Cancel
          </button>
        </td>
      </tr>
